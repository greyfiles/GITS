...
|Issues reports: there are **many**| 3| [in GH](https://github.com/greyfiles/CSC510-Projects/issues?q=)|
|Issues are being closed| 3|[evidence in GH](https://github.com/greyfiles/CSC510-Projects/issues?q=is%3Aclosed)|
|DOI badge: exists| 3| |
|Docs: doco generated, format not ugly| 3|[in GH](https://github.com/greyfiles/GITS/blob/master/README.md)|
|Docs: what: point descriptions of each class/function (in isolation)| 3| [in GH](https://github.com/greyfiles/GITS/tree/master/docs)|
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z| 2|[doc page entries](https://github.com/greyfiles/GITS/tree/master/docs)|
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing| 2| [in GH](https://github.com/greyfiles/GITS/blob/master/README.md)|
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.| 2| [in GH](https://www.youtube.com/watch?v=6Y8_RQecnZ8&feature=youtu.be)|
|Use of version control tools| 3| [in GH](https://github.com/greyfiles/GITS/tree/master)|
|Use of style checkers | 2|[config files in GH showing your config](https://github.com/greyfiles/GITS/tree/master/configurations)|
|Use of code formatters.| 2|Flake8|
|Use of syntax checkers.| 2|Flake8|
|Use of code coverage| 3| |
|Other automated analysis tools| 0|config files in GH|
|Test cases exist| 3|[dozens of tests and those test cases are more than 30% of the code base](https://github.com/greyfiles/GITS/tree/master/test)|
|Test cases are routinely executed| 3|[E.g. travis-com.com or github actions or something](https://github.com/greyfiles/GITS/blob/master/.travis.yml)|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up| 3|[ in GH](https://github.com/greyfiles/GITS/blob/master/CONTRIBUTING.md)|
|Issues are discussed before they are closed| 3|[Issues are discussed in both discord and GH Issues before closed](https://github.com/greyfiles/CSC510-Projects/issues?q=)|
|Chat channel: exists| 3|![Link or screenshots](channel_image.png)|
...
|Evidence that the whole team is using the same tools: everyone can get to all tools and files| 3| No tools besides python and coverage|
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)| 2| Some config in repo for python|
